...
export const ENDPOINTS = {
  ...
  usuarios: { perfilPropio: '/usuarios/me/perfil', activarSolicitante: '/usuarios/me/roles/solicitante', modoSolicitante: '/usuarios/me/roles/solicitante', perfilSolicitante: (id: string) => `/usuarios/${id}/perfil-solicitante`, perfilProveedor: (id: string) => `/usuarios/${id}/perfil-proveedor` },
  solicitudes: {
    list: '/solicitudes',
  ...
  moderacion: { resenasMias: '/moderacion/resenas/mias', resenasSolicitanteMias: '/moderacion/resenas-solicitante/mias', bloqueosMios: '/moderacion/bloqueos/mios', bloquear: '/moderacion/bloqueos', desbloquear: (blockedId: string) => `/moderacion/bloqueos/${blockedId}`, incidencia: '/moderacion/incidencias' },
